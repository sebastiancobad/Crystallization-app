    ...
    <div className="grid grid-cols-[220px_1fr] min-h-screen">
      ...
      <main className="overflow-y-auto">
        ...
        <div className="sticky top-0 z-20 h-[52px] bg-canvas/85 backdrop-blur-md border-b border-border-soft px-6 flex items-center justify-between">
          <h1 className="text-sm font-medium text-text-primary">Design System Showcase</h1>
          <span className="text-xs text-text-tertiary">PolymerCryst v0.1</span>
        </div>

        <motion.div
          className="max-w-[1200px] mx-auto px-6 py-7 pb-16"
          variants={stagger}
          initial="initial"
          animate="animate"
        >
