      ...
      {lines.map((seg, i) => {
        ...
        return (
          <lineSegments key={i} geometry={geom}>
            <lineBasicMaterial color="#122850" transparent opacity={0.08} />
          </lineSegments>
        );
      })}
    </group>
...
function Scene() {
  ...
  return (
    <>
      ...
      <directionalLight position={[-3, 2, -2]} intensity={0.3} color="#1B3A6B" />
      <pointLight position={[0, 3, 2]} intensity={0.5} color="#3B6298" />
